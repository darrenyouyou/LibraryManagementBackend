...
public class BorrowRecordController {
    ...
    @GetMapping("/borrow_record/user/{userId}")
    public ResponseEntity<Iterable<BorrowRecord>> findByUserId(@PathVariable Integer userId) {
        System.out.println(userId);
        Iterable<BorrowRecord> borrowRecord = borrowRecordService.findByUserId(userId);
        return new ResponseEntity<>(borrowRecord, HttpStatus.OK);
    }
}
