...
INSERT INTO inventories (isbn, store_time, status) VALUES (9876543210, EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), 'AVAILABLE');
INSERT INTO inventories (isbn, store_time, status) VALUES (1112233445, EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), 'AVAILABLE');
-- BorrowRecord
